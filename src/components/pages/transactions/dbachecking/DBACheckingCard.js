...
const DBACheckingCard = ({
    dbaTransactions
}) => {
    console.log(dbaTransactions);
    const classes = useStyles();
    const isEmpty = dbaTransactions;
    return (
            ...
            {isEmpty === undefined ?
                ...
                <TableContainer component={Paper} variant="outlined" elevation={20}>
                    <Table className={classes.table} aria-label="customized table">
                        ...
                        <TableBody>
                            {dbaTransactions.map((transactions) => (
                                <StyledTableRow key={transactions.type}>
                                    <StyledTableCell component="th" scope="row">
                                        {transactions.type}
                                    </StyledTableCell>
                                    <StyledTableCell align="center">${transactions.amount}</StyledTableCell>
...
export default DBACheckingCard;